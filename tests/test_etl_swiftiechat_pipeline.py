...
def test_imports_modules():
    ...
    from python.transform import normalize_lyrics, clean_text, remove_symbols, split_by_capitals, space_song_names
...
def test_etl_swiftiechat_pipeline_initialization():
    ...
    etl_pipeline = ETLSwiftieChatPipeline(collection_name, file_summary_songs, swiftie_chat_instructions, data_path, vectordb_file_name)
